        ...
        <div className="w-full md:w-1/2 mb-4 md:mb-0 md:pr-4">
          ...
          <div className="space-y-6">
            <div className="flex items-start">
               <span className="text-indigo-500 mr-3 mt-1"></span> size={20} <FaMapMarkerAlt/>
              <div>
            ...
            <div className="flex items-start">
              <span className="text-green-500 mr-3 mt-1"></span> size={20} <FaPhoneAlt/>
              <div>
            ...
            <div className="flex items-start">
              <span className="text-yellow-500 mr-3 mt-1" ></span>size={20}  <FaClock/>
