    ...
    <div className="flex flex-col text-white">
      ...
      <div className="flex justify-between items-center px-12 sm:px-16 md:px-28 lg:px-40 bg-slate-50 text-black py-2 flex-wrap">
        <div className="flex items-center gap-4">
          <span className="text-emerald-500 h-6 w-6 sm:h-8 sm:w-8 md:h-10 md:w-10"></span> <GiSofa/>
        ...
        <div>
          <ul className="flex items-center gap-6 text-xs sm:text-sm">
            <li>
           <Link href={"./Card"}>  <span className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-500"></span><FaCartShopping/> </Link> 
            </li>
            <li>Cart</li>
            <li>
