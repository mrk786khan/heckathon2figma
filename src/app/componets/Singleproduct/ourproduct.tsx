...
export default function OurProduct() {
  const FeatureImage = [
    '/featuredata/chair1.png',
    '/featuredata/chair2.png',
    '/featuredata/chair3.png',
    '/featuredata/chair4.png',
    '/featuredata/chair5.png',
    '/featuredata/chair6.png',
    '/featuredata/chair7.png',
    '/featuredata/chair8.png',
  ];
            ...
            <div key={i} className="flex flex-col items-center bg-white rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 hover:scale-105 hover:shadow-2xl">
              ...
              <div className="flex justify-between w-full px-4 py-2">
                ...
                <div className="flex items-center">
                  <span className="w-6 h-6 sm:w-8 sm:h-8 text-emerald-500 cursor-pointer transition-transform duration-300 hover:scale-110" ></span><FaCartShopping />
                </div>
              </div>
            </div>
          ))}
